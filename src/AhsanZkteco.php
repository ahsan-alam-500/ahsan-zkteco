...
use ErrorException;
use Exception;
use Ahsan\AhsanZkteco\Lib\Attendance;
use Ahsan\AhsanZkteco\Lib\Connect;
use Ahsan\AhsanZkteco\Lib\Device;
use Ahsan\AhsanZkteco\Lib\Face;
use Ahsan\AhsanZkteco\Lib\Fingerprint;
use Ahsan\AhsanZkteco\Lib\Os;
use Ahsan\AhsanZkteco\Lib\Pin;
use Ahsan\AhsanZkteco\Lib\Platform;
use Ahsan\AhsanZkteco\Lib\SerialNumber;
use Ahsan\AhsanZkteco\Lib\Ssr;
use Ahsan\AhsanZkteco\Lib\Time;
use Ahsan\AhsanZkteco\Lib\User;
use Ahsan\AhsanZkteco\Lib\Util;
use Ahsan\AhsanZkteco\Lib\Version;
use Ahsan\AhsanZkteco\Lib\WorkCode;
...
class AhsanZkteco
{
    ...
    {
        return Device::writeLCD($this, 2, 'Ahsan ZkTeco');
    }
}
