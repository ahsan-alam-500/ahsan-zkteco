...
class User
{
     ...
     * @return bool|mixed
     */
    public static function set(AhsanZkteco $self, $uid, $userid, $name, $password, $role = Util::LEVEL_USER, $cardno = 0)
    {
     ...
     * @return bool|mixed
     */
    public static function clear(AhsanZkteco $self)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool|mixed
     */
    public static function clearAdmin(AhsanZkteco $self)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool|mixed
     */
    public static function remove(AhsanZkteco $self, $uid)
    {
        $self->_section = __METHOD__;
