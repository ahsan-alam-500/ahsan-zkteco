...
class Fingerprint
{
     ...
     */
    public static function get(AhsanZkteco $self, $uid)
    {
     ...
     * @return array
     */
    private function _getFinger(AhsanZkteco $self, $uid, $finger)
    {
     ...
     */
    public static function set(AhsanZkteco $self, $uid, array $data)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool|mixed
     */
    private function _setFinger(AhsanZkteco $self, $data)
    {
     ...
     */
    public static function remove(AhsanZkteco $self, $uid, array $data)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool
     */
    private function _removeFinger(AhsanZkteco $self, $uid, $finger)
    {
     ...
     */
    private function _checkFinger(AhsanZkteco $self, $uid, $finger)
    {
        $fingerPrint = new Fingerprint();
